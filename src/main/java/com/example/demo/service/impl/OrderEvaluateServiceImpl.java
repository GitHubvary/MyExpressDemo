...
import com.example.demo.mapper.OrderEvaluateMapper;
...
public class OrderEvaluateServiceImpl extends ServiceImpl<OrderEvaluateMapper, OrderEvaluate> implements OrderEvaluateService {
    ...
    @Override
    public boolean canEvaluate(String orderId, String userId, UserRoleEnum roleEnum) {
    ...
    public ResponseResult userEvaluate(String orderId, String userId, double score, String text) {
        ...
        /* 更新配送员评分 */
        if(!userEvaluateService.updateEvaluate(orderId, score, UserRoleEnum.COURIER)) {
            transactionManager.rollback(status);
